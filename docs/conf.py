# -*- coding: utf-8 -*-
#
# PyModelFit documentation build configuration file, created by
...
project = u'PyModelFit'
copyright = u'2011, Erik Tollerud'
...
from pymodelfit import version
...
htmlhelp_basename = 'PyModelFitdoc'
...
latex_documents = [
  ('index', 'PyModelFit.tex', u'PyModelFit Documentation',
...
man_pages = [
    ('index', 'pymodelfit', u'PyModelFit Documentation',
     [u'Erik Tollerud'], 1)
]
